...
<head>
	...
	<link rel="stylesheet" href="css/estilopop.css">
	<title>PRESTAMOS | SGA</title>
</head>
<body>
	<header>
		...
		while($row = mysqli_fetch_array($Resultadoarts)) { 
			...
			<td><img src='vista.php?idart=3' class='Imagenes' width='100px' height='100px'></td>
					<td>
   					...
   					<td>".$row['piezasart']."</td>
   					<td>
   						<a href='eliminar.php?idart=".$row['idart']."'><img src='vectores/bote.svg' height='20px' weight='20px'></a>
                    </td>
						 </tr>";
  			echo "</tbody>";
		}
